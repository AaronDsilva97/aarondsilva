    ...
    const updateTime = () => {
      ...
      setStatus(prev => ({
        ...
        status: isWorkingHours
          ? 'Available for co-founding opportunities'
          : 'Exploring new ventures • Open to strategic partnerships',
      }));
    };
  ...
  return (
    <div className="flex flex-col justify-center h-full opacity-100 transition-opacity duration-1000">
      <div className="space-y-4">
        ...
        <div className="pt-2">
          <button
            onClick={() => window.open('https://calendly.com/aaron-theleanproduct/30min', '_blank')}
