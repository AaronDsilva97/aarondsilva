      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <span className={`text-sm font-semibold ${
            status.available ? 'text-emerald-600 dark:text-emerald-300' : 'text-orange-600 dark:text-orange-300'
          }`}>
        ...
        <div className="space-y-3">
          ...
          <div className="text-xs text-slate-500 dark:text-slate-400 space-y-2">
            <div className="flex items-center justify-between p-2 rounded-lg bg-slate-100/50 dark:bg-slate-800/30 border border-slate-200/50 dark:border-slate-700/30">
              ...
              <span className="font-mono text-slate-700 dark:text-slate-300">{status.localTime} {status.timezone}</span>
            </div>
            ...
            <div className="flex items-center justify-between p-2 rounded-lg bg-slate-100/50 dark:bg-slate-800/30 border border-slate-200/50 dark:border-slate-700/30">
              ...
              <span className="text-emerald-600 dark:text-emerald-400 font-medium">~6 hours</span>
            </div>
          </div>
        </div>
