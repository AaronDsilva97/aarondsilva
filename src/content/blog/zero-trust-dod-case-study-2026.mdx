...
November 2020. [SolarWinds](https://www.cisa.gov/news-events/cybersecurity-advisories/aa20-352a).
...
Results were mixed. [Many agencies made progress](https://www.dhs.gov/sites/default/files/2025-04/2025_0129_cisa_zero_trust_architecture_implementation.pdf) on identity and access management. But full implementation lagged due to legacy systems, budget constraints, and organizational complexity.
...
The pattern here matches what I saw in [McKinsey's research on AI transformation](/blog/state-of-ai-2025-why-94-percent-fail/): high performers build platforms, not point solutions.
...
[CISA's Zero Trust Maturity Model v2.0](https://www.cisa.gov/zero-trust-maturity-model) defines three maturity levels:
...
This is the same pattern that separates [the 6% of high-performing AI organizations](/blog/state-of-ai-2025-why-94-percent-fail/) from everyone else.
...
[CISA's January 2025 report](https://www.dhs.gov/sites/default/files/2025-04/2025_0129_cisa_zero_trust_architecture_implementation.pdf) shows civilian agencies are making progress. Identity and access management are improving. Encryption is becoming standard. Incident logging is more comprehensive.
...
- [CISA Zero Trust Architecture Implementation Report](https://www.dhs.gov/sites/default/files/2025-04/2025_0129_cisa_zero_trust_architecture_implementation.pdf) - Federal agency progress report
